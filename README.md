...
Below is a list of all extractors that are currently included with Dark Downloader.
If a site is not listed here, it might still be supported by Dark Downloader embed extraction or generic extractor.
Not all sites listed here are guaranteed to work; websites are constantly changing and sometimes this breaks Dark Downloader support for them.
